...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.combinedViewController=(CombinedViewController*)self.window.rootViewController;
...
-(void)createEditableCopyOfDataBaseIfNeeded
{
    ...
    NSURL *documentDir=[self applicationDocumentsDirectory];
    NSURL *writableDBPath=[documentDir URLByAppendingPathComponent:@"iBountyHunter.sqlite"];
    ...
    if (!dbexists)
    {
        ...
        NSError *error;
        BOOL success=[fileManager copyItemAtPath:[defaultDBPath path] toPath:[writableDBPath path] error:&error];
        if (!success)
        {
